...
function productEvent() {
  ...
  card.forEach((element) => {
    ...
    image.addEventListener("click", function (e) {
      ...
      const idx = dataProduct.findIndex((val) => val.image === image.src);
      quickView.innerHTML = `
                <div class="quickview-image">
                    <img src=${dataProduct[idx].image} alt=${dataProduct[idx].name}>
                </div>
                <div class="quickview-details">
                    <span class="product-name">${dataProduct[idx].name}</span>
                    <span class="product-price">${dataProduct[idx].price} $</span>
                </div>
            `;
