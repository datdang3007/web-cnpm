...
console.log("getCartUser:", getCartUser);
let cart = [];
const modalWrapper = document.querySelector(".modal-wrapper");
if (getCartUser) {
  $(".user-name").append(`${getCartUser.name}`).css({
    color: "#666",
    "font-size": "14px",
  });
  if (getCartUser.carts) {
    cart = [...getCartUser.carts];
  }
  $(".get-login").html("Your profile");
  $(".get-register").html("Logout").attr("href", "");
}
renderCart();
renderQuantity();
delProductCart();
