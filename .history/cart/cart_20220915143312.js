...
$(document).ready(function () {
  ...
  function renderCart() {
    $(".products-cart").html("");
    // const delProduct = document.querySelectorAll(".product");
    // delProduct.forEach((val) => {
    //   val.remove();
    // });
                          ...
                          <div class="content">
                              ...
                              <div class="action-cart">
                                  ...
                                  <div class="group-quantity-cart">
                                      ...
                                      <input class="quantity-input-cart" type="number" data-id="${
                                        val.id
  ...
  $(document).ready(function () {
    $(".btnAddToCart").click(function (e) {
      ...
      console.log("checkInCart:", checkInCart);
