$(document).ready(function () {
  ...
  const formLogin = `<div class="login similer">
                    <div class="form-login form-similer">
                        <input type="email" class="login-input" placeholder="Username or Email Address*">
  ...
  const formRegister = `<div class="register similer">
                    <div class="form-register form-similer">
                        <input type="email" class="register-input" placeholder="Your Email Address*">
                        <input type="password" class="register-pass" placeholder="Password*">
                        <div class="input-show-pass">
        ...
        <div class="backgr">
            <div class="wrapper-form">
                ...
                <div class="login similer">
                    <div class="form-login form-similer">
                        <input type="email" class="register-email" placeholder="Username or Email Address*">
                        <div class="input-show-pass">
                          <input class="login-pass" type="password"  placeholder="Password*">
                          <button class="show-pass">
                            <i class="fa-regular fa-eye-slash"></i>
